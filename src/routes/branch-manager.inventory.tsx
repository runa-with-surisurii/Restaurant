...
export const Route = createFileRoute("/branch-manager/inventory")({
  head: () => ({
    meta: [{ title: "Inventory — Branch Manager" }, { name: "robots", content: "noindex" }],
  }),
  component: () => (
    <div className="space-y-4">
      <div className="mx-auto max-w-[1400px] px-4 pt-4 md:px-8 md:pt-8">
        <div className="rounded-2xl border border-primary/20 bg-primary/5 p-4">
          ...
          <div className="text-xs text-muted-foreground">Stock levels scoped to your branch only.</div>
        </div>
      </div>
      <InventoryPage />
    </div>
