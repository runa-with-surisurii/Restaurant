...
const REVIEWS: Review[] = [
  { id: "r1", customerName: "Sophia Reynolds", rating: 5, date: "2026-07-26", branchId: "br-downtown", branchName: "Downtown Kitchen", dishes: ["Oakwood Ribeye 12oz", "Molten Chocolate Oak"], sentiment: "Positive", headline: "Anniversary dinner — perfect!", content: "The ribeye was cooked exactly medium-rare as requested. Our server remembered the occasion and brought a small dessert plate with a candle. Will absolutely be back.", approved: true, reply: "Thank you Sophia! So pleased we could make your anniversary special. — Michael, GM" },
  { id: "r2", customerName: "Daniel Kim", rating: 4, date: "2026-07-26", branchId: "br-harbor", branchName: "Harbor Side Grill", dishes: ["Wood-Fired Margherita"], sentiment: "Positive", headline: "Great crust, slightly salty", content: "Margherita was excellent char from the wood oven. A touch more basil would elevate it further. Will come back for the patio.", approved: true },
  { id: "r3", customerName: "Maya Patel", rating: 2, date: "2026-07-25", branchId: "br-westside", branchName: "Westside Kitchen", dishes: ["Smoked Bacon Ember Burger"], sentiment: "Negative", headline: "Buns were stale — very disappointed", content: "The burger patty itself was great but the brioche buns seemed a day or two old. Not what I expect from Ember & Oak.", approved: false },
  { id: "r4", customerName: "Jordan Smith", rating: 5, date: "2026-07-25", branchId: "br-downtown", branchName: "Downtown Kitchen", dishes: ["Roman Carbonara", "Ember Buffalo Wings"], sentiment: "Positive", headline: "Carbonara blew me away", content: "Proper guanciale, no cream. Exactly how it's made in Rome. Buffalo wings had great heat. Fantastic overall.", approved: true },
  { id: "r5", customerName: "Ava Thompson", rating: 3, date: "2026-07-24", branchId: "br-riverfront", branchName: "Riverfront Patio", dishes: ["Harvest Berry Trifle"], sentiment: "Neutral", headline: "Good dessert but slow", content: "Trifle was tasty but our wait for dessert was 28 minutes on a slow Monday. Food OK, service speed could improve.", approved: true },
  { id: "r6", customerName: "Luis Hernandez", rating: 5, date: "2026-07-24", branchId: "br-westside", branchName: "Westside Kitchen", dishes: ["Oakwood Ribeye 12oz", "Truffle Parmesan Fries"], sentiment: "Positive", headline: "Perfect grill marks", content: "Best ribeye I've had in the city. Truffle fries were a great side. Friendly staff too.", approved: true },
  { id: "r7", customerName: "Emma Wright", rating: 1, date: "2026-07-23", branchId: "br-harbor", branchName: "Harbor Side Grill", dishes: ["Takeout — Mixed grill"], sentiment: "Negative", headline: "Order was missing sides", content: "Ordered a family takeout, missed 2 sides and the sauces were all wrong. First bad experience in 3 years.", approved: false },
  { id: "r8", customerName: "Noah Chen", rating: 4, date: "2026-07-23", branchId: "br-downtown", branchName: "Downtown Kitchen", dishes: ["Smoked Bacon Ember Burger"], sentiment: "Positive", headline: "Lunch combo — solid!", content: "Weekday lunch combo with drink for $15 is great value. Burger was juicy, drink was cold. Good deal.", approved: true },
];
